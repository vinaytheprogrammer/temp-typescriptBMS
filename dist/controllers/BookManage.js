...
export class BookManage {
    ...
    attachEventListeners() {
        ...
        if (this.form) {
            (_a = document
                .getElementById("applyFilters")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => this.bookDOMe.filterBooks());
            (_b = document
                .getElementById("resetFilters")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => this.bookDOMe.resetFilters());
            ...
            (_e = document
                .querySelector("#editBookForm button")) === null || _e === void 0 ? void 0 : _e.addEventListener("click", this.handleEdit.bind(this)); // bind helps to access the this keyword
            (_f = document
                .querySelector("#deleteBookForm button")) === null || _f === void 0 ? void 0 : _f.addEventListener("click", () => this.handleDelete()); // no need to call using bind() in arrow function
        }
    }
    fetchBooks() {
        return __awaiter(this, void 0, void 0, function* () {
